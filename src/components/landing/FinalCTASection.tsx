...
export const FinalCTASection = () => {
  ...
  return (
    <section ref={ref} className="relative py-32 bg-black overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-gradient-to-br from-gold-500/20 to-transparent rounded-full blur-3xl animate-pulse" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-warmGray-300 mb-12"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center gap-8 text-warmGray-400"
          >
