      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="text-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gold-500/10 border border-gold-500/30 rounded-full px-5 py-2.5 mb-8"
          >
            <Wifi className="w-4 h-4 text-gold-400 animate-pulse" />
          ...
          >
            Une carte noire.
            <motion.span
              className="block bg-gradient-gold bg-clip-text text-transparent mt-2"
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-warmGray-300 mb-6 max-w-3xl mx-auto leading-relaxed"
          >
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-warmGray-400 mb-12 max-w-2xl mx-auto"
          >
            ...
            {[
              ...
              >
                <div className="relative inline-block">
                  ...
                  <div className="absolute inset-0 bg-gradient-gold opacity-0 group-hover:opacity-20 blur-2xl transition-opacity" />
                </div>
                <div className="text-sm md:text-base text-warmGray-400 uppercase tracking-wider">
                  {stat.label}
                </div>
              </motion.div>
            ))}
